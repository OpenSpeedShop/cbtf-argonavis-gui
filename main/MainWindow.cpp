    ...
    , ui( new Ui::MainWindow )
{
    ...
    if ( dataMgr ) {
        ...
        connect( dataMgr, &PerformanceDataManager::addMetricView, ui->widget_SourceCodeViewer, &SourceView::handleAddMetricView );
        connect( dataMgr, &PerformanceDataManager::addMetricViewData, ui->widget_SourceCodeViewer, &SourceView::handleAddMetricViewData );
        ...
        connect( dataMgr, SIGNAL(addMetricView(QString,QString,QString,QStringList)),
                 ui->widget_SourceCodeViewer, SLOT(handleAddMetricView(QString,QString,QString,QStringList)) );
        connect( dataMgr, SIGNAL(addMetricViewData(QString,QString,QString,QVariantList,QStringList)),
                 ui->widget_SourceCodeViewer, SLOT(handleAddMetricViewData(QString,QString,QString,QVariantList,QStringList)) );
