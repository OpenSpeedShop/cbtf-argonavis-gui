...
private slots:
    ...
    void handleSetDefaultMetricView(const MetricViewTypes& view, bool hasDerivedMetrics, bool hasCompareViews, bool hasLoadBalanceViews, bool hasTraceViews, bool hasCallTreeViews);
