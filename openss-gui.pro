...
exists($$QTGRAPHLIB_ROOT/$$ALT_BUILDLIB): LIBS += -L$$QTGRAPHLIB_ROOT/$$ALT_BUILDLIB -LQtGraphd
exists($$QTGRAPHLIB_ROOT/$$BUILDLIB): LIBS += -L$$QTGRAPHLIB_ROOT/$$BUILDLIB -LQtGraphd
}
CONFIG(release, debug|release) {
#LIBS += -L$$QTGRAPHLIB_ROOT/lib64/$$QT_VERSION -lQtGraph
#LIBS += -L$$QTGRAPHLIB_ROOT/lib64 -lQtGraph
exists($$QTGRAPHLIB_ROOT/$$ALT_BUILDLIB): LIBS += -L$$QTGRAPHLIB_ROOT/$$ALT_BUILDLIB -LQtGraph
exists($$QTGRAPHLIB_ROOT/$$BUILDLIB): LIBS += -L$$QTGRAPHLIB_ROOT/$$BUILDLIB -LQtGraph
}
